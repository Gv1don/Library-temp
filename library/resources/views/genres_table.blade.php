<div class="headTable">
    ...
    <form action="{{ route('create') }}" method="GET">
        @csrf
        <button name="type" value="Genre" type="submit" class="btn btn-primary" style="margin-top: 30px; max-height: 40px; max-width: 200px">+ Добавить жанр</button>
    </form>
</div>
                ...
                <td class="col-1">
                    <div class="dashboard">
                        <form action="{{ route('update') }}" method="GET">
                            @csrf
                            <button type="submit" class="btn btn-primary" name="id" value="{{ $row->genre_id }}">
                        ...
                        <form action="{{ route('delete') }}" method="POST">
                            @csrf
                            <button type="submit" class="btn btn-outline-danger" name="id" value="{{ $row->genre_id }}">
