<div class="headTable">
    <h2 class="tableName">Читательские билеты</h2>
    <form action="{{ route('create') }}" method="GET">
        @csrf
        <button name="type" value="Library_card" type="submit" class="btn btn-primary" style="margin-top: 30px; max-height: 40px; max-width: 200px">+ Добавить запись</button>
    </form>
</div>
    ...
    <table class="table table-striped table-lg table-hover">
        <thead>
            <tr>
                ...
                <th class="text-center">Дата аренды</th>
